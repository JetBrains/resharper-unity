...
namespace JetBrains.ReSharper.Plugins.Unity.Feature.Services.LiveTemplates.Scope
{
    ...
    public class InProjectWithUnityVersion : InAnyFile, IMandatoryScopePoint
    {
        // Serialised name, so don't use nameof
        public const string TypeName = "InProjectWithUnityVersion";
        ...
        public InProjectWithUnityVersion(Version minimumVersion)
        {
        ...
        public override bool IsSubsetOf(ITemplateScopePoint allowed)
        {
            ...
            if (allowed is InProjectWithUnityVersion allowedScopePoint)
            {
