...
namespace JetBrains.ReSharper.Plugins.Unity.Psi.ShaderLab.Parsing
{
  public partial class ShaderLabTokenType
  {
    ...
    public const int PLUS_MINUS_NODE_TYPE_INDEX = 1021;
    public static readonly TokenNodeType PLUS_MINUS = new FixedTokenNodeType("PLUS_MINUS", PLUS_MINUS_NODE_TYPE_INDEX, representation: "+-");

    //Tokens
    #region PP_WARNING
    
    public static readonly TokenNodeType PP_WARNING = new PpWarningNodeType();
    public const int PP_WARNING_NODE_TYPE_INDEX = 1022;
    
    private class PpWarningNodeType : FixedTokenNodeType
    {
      public PpWarningNodeType() : base("PP_WARNING", PP_WARNING_NODE_TYPE_INDEX, "#warning") { }
    
      public override LeafElementBase Create(IBuffer buffer, TreeOffset startOffset, TreeOffset endOffset)
      {
        return new PpWarningTokenElement();
      }
    
      public override bool IsFiltered { get { return true; } }
    }
    
    private class PpWarningTokenElement : FixedTokenElementBase
    {
      public override NodeType NodeType { get { return PP_WARNING; } }
    ...
    public static readonly TokenNodeType PP_ERROR = new PpErrorNodeType();
    public const int PP_ERROR_NODE_TYPE_INDEX = 1023;
    
    private class PpErrorNodeType : FixedTokenNodeType
    {
      public PpErrorNodeType() : base("PP_ERROR", PP_ERROR_NODE_TYPE_INDEX, "#error") { }
    
      public override LeafElementBase Create(IBuffer buffer, TreeOffset startOffset, TreeOffset endOffset)
      {
        return new PpErrorTokenElement();
      }
    
      public override bool IsFiltered { get { return true; } }
    }
    
    private class PpErrorTokenElement : FixedTokenElementBase
    {
      public override NodeType NodeType { get { return PP_ERROR; } }
    ...
    public const int PP_LINE_NODE_TYPE_INDEX = 1024;
    
    private class PpLineNodeType : FixedTokenNodeType
    {
      public PpLineNodeType() : base("PP_LINE", PP_LINE_NODE_TYPE_INDEX, "#line") { }
    
      public override LeafElementBase Create(IBuffer buffer, TreeOffset startOffset, TreeOffset endOffset)
      {
        return new PpLineTokenElement();
      }
    
      public override bool IsFiltered { get { return true; } }
    }
    
    private class PpLineTokenElement : FixedTokenElementBase
    {
      public override NodeType NodeType { get { return PP_LINE; } }
    ...
    //Commands
    public const int SHADER_KEYWORD_NODE_TYPE_INDEX = 1025;
    ...
    public const int PROPERTIES_KEYWORD_NODE_TYPE_INDEX = 1026;
    ...
    public const int CATEGORY_KEYWORD_NODE_TYPE_INDEX = 1027;
    ...
    public const int SUB_SHADER_KEYWORD_NODE_TYPE_INDEX = 1028;
    ...
    public const int FALLBACK_KEYWORD_NODE_TYPE_INDEX = 1029;
    ...
    public const int CUSTOM_EDITOR_KEYWORD_NODE_TYPE_INDEX = 1030;
    ...
    public const int DEPENDENCY_KEYWORD_NODE_TYPE_INDEX = 1031;
    ...
    public const int COLOR_KEYWORD_NODE_TYPE_INDEX = 1032;
    ...
    public const int FLOAT_KEYWORD_NODE_TYPE_INDEX = 1033;
    ...
    public const int INT_KEYWORD_NODE_TYPE_INDEX = 1034;
    ...
    public const int RANGE_KEYWORD_NODE_TYPE_INDEX = 1035;
    ...
    public const int VECTOR_KEYWORD_NODE_TYPE_INDEX = 1036;
    ...
    public const int ANY_KEYWORD_NODE_TYPE_INDEX = 1037;
    ...
    public const int CUBE_KEYWORD_NODE_TYPE_INDEX = 1038;
    ...
    public const int CUBE_ARRAY_KEYWORD_NODE_TYPE_INDEX = 1039;
    public static readonly TokenNodeType CUBE_ARRAY_KEYWORD = new KeywordTokenNodeType("CUBE_ARRAY_KEYWORD", CUBE_ARRAY_KEYWORD_NODE_TYPE_INDEX, representation: "CubeArray");
    public const int RECT_KEYWORD_NODE_TYPE_INDEX = 1040;
    public static readonly TokenNodeType RECT_KEYWORD = new KeywordTokenNodeType("RECT_KEYWORD", RECT_KEYWORD_NODE_TYPE_INDEX, representation: "Rect");
    public const int TEXTURE_2D_KEYWORD_NODE_TYPE_INDEX = 1041;
    ...
    public const int TEXTURE_2D_ARRAY_KEYWORD_NODE_TYPE_INDEX = 1042;
    public static readonly TokenNodeType TEXTURE_2D_ARRAY_KEYWORD = new KeywordTokenNodeType("TEXTURE_2D_ARRAY_KEYWORD", TEXTURE_2D_ARRAY_KEYWORD_NODE_TYPE_INDEX, representation: "2DArray");
    public const int TEXTURE_3D_KEYWORD_NODE_TYPE_INDEX = 1043;
    ...
    //SubShaderCommands
    public const int TAGS_KEYWORD_NODE_TYPE_INDEX = 1044;
    ...
    public const int PASS_KEYWORD_NODE_TYPE_INDEX = 1045;
    ...
    public const int USEPASS_KEYWORD_NODE_TYPE_INDEX = 1046;
    ...
    public const int GRABPASS_KEYWORD_NODE_TYPE_INDEX = 1047;
    ...
    //RenderStateCommands
    public const int CULL_KEYWORD_NODE_TYPE_INDEX = 1048;
    ...
    public const int ZCLIP_KEYWORD_NODE_TYPE_INDEX = 1049;
    public static readonly TokenNodeType ZCLIP_KEYWORD = new KeywordTokenNodeType("ZCLIP_KEYWORD", ZCLIP_KEYWORD_NODE_TYPE_INDEX, representation: "ZClip");
    public const int ZTEST_KEYWORD_NODE_TYPE_INDEX = 1050;
    ...
    public const int ZWRITE_KEYWORD_NODE_TYPE_INDEX = 1051;
    ...
    public const int OFFSET_KEYWORD_NODE_TYPE_INDEX = 1052;
    ...
    public const int BLEND_KEYWORD_NODE_TYPE_INDEX = 1053;
    ...
    public const int BLEND_OP_KEYWORD_NODE_TYPE_INDEX = 1054;
    ...
    public const int ALPHA_TO_MASK_KEYWORD_NODE_TYPE_INDEX = 1055;
    ...
    public const int COLOR_MASK_KEYWORD_NODE_TYPE_INDEX = 1056;
    ...
    public const int STENCIL_KEYWORD_NODE_TYPE_INDEX = 1057;
    ...
    public const int NAME_KEYWORD_NODE_TYPE_INDEX = 1058;
    ...
    public const int LOD_KEYWORD_NODE_TYPE_INDEX = 1059;
    ...
    public const int BIND_CHANNELS_KEYWORD_NODE_TYPE_INDEX = 1060;
    ...
    public const int BACK_KEYWORD_NODE_TYPE_INDEX = 1061;
    ...
    public const int FRONT_KEYWORD_NODE_TYPE_INDEX = 1062;
    ...
    public const int LIGHTING_KEYWORD_NODE_TYPE_INDEX = 1063;
    ...
    public const int MATERIAL_KEYWORD_NODE_TYPE_INDEX = 1064;
    ...
    public const int SEPARATE_SPECULAR_KEYWORD_NODE_TYPE_INDEX = 1065;
    ...
    public const int COLOR_MATERIAL_KEYWORD_NODE_TYPE_INDEX = 1066;
    ...
    public const int FOG_KEYWORD_NODE_TYPE_INDEX = 1067;
    ...
    public const int ALPHA_TEST_KEYWORD_NODE_TYPE_INDEX = 1068;
    ...
    public const int SET_TEXTURE_KEYWORD_NODE_TYPE_INDEX = 1069;
    ...
    public const int DIFFUSE_KEYWORD_NODE_TYPE_INDEX = 1070;
    ...
    public const int AMBIENT_KEYWORD_NODE_TYPE_INDEX = 1071;
    ...
    public const int SPECULAR_KEYWORD_NODE_TYPE_INDEX = 1072;
    ...
    public const int SHININESS_KEYWORD_NODE_TYPE_INDEX = 1073;
    ...
    public const int COMBINE_KEYWORD_NODE_TYPE_INDEX = 1074;
    ...
    public const int CONSTANT_COLOR_KEYWORD_NODE_TYPE_INDEX = 1075;
    ...
    public const int MATRIX_KEYWORD_NODE_TYPE_INDEX = 1076;
    ...
    public const int LIGHTMAP_MODE_KEYWORD_NODE_TYPE_INDEX = 1077;
    ...
    public const int TEX_GEN_KEYWORD_NODE_TYPE_INDEX = 1078;
    public static readonly TokenNodeType TEX_GEN_KEYWORD = new KeywordTokenNodeType("TEX_GEN_KEYWORD", TEX_GEN_KEYWORD_NODE_TYPE_INDEX, representation: "TexGen");

    //LegacyTextureCombinerKeywords
    public const int PREVIOUS_KEYWORD_NODE_TYPE_INDEX = 1079;
    ...
    public const int PRIMARY_KEYWORD_NODE_TYPE_INDEX = 1080;
    ...
    public const int TEXTURE_KEYWORD_NODE_TYPE_INDEX = 1081;
    ...
    public const int CONSTANT_KEYWORD_NODE_TYPE_INDEX = 1082;
    ...
    public const int DOUBLE_KEYWORD_NODE_TYPE_INDEX = 1083;
    ...
    public const int QUAD_KEYWORD_NODE_TYPE_INDEX = 1084;
    ...
    public const int LERP_KEYWORD_NODE_TYPE_INDEX = 1085;
    ...
    public const int ONE_KEYWORD_NODE_TYPE_INDEX = 1086;
    ...
    public const int ALPHA_KEYWORD_NODE_TYPE_INDEX = 1087;
    ...
    public const int DOT3_KEYWORD_NODE_TYPE_INDEX = 1088;
    public static readonly TokenNodeType DOT3_KEYWORD = new KeywordTokenNodeType("DOT3_KEYWORD", DOT3_KEYWORD_NODE_TYPE_INDEX, representation: "Dot3");
    public const int DOT3RGBA_KEYWORD_NODE_TYPE_INDEX = 1089;
    public static readonly TokenNodeType DOT3RGBA_KEYWORD = new KeywordTokenNodeType("DOT3RGBA_KEYWORD", DOT3RGBA_KEYWORD_NODE_TYPE_INDEX, representation: "Dot3Rgba");

    //LegacyTexGenModeKeywords
    public const int SPHERE_MAP_KEYWORD_NODE_TYPE_INDEX = 1090;
    ...
    public const int EYE_LINEAR_KEYWORD_NODE_TYPE_INDEX = 1091;
    ...
    public const int CUBE_REFLECT_KEYWORD_NODE_TYPE_INDEX = 1092;
    ...
    public const int CUBE_NORMAL_KEYWORD_NODE_TYPE_INDEX = 1093;
    ...
    public const int OBJECT_LINEAR_KEYWORD_NODE_TYPE_INDEX = 1094;
    ...
    public const int BIND_KEYWORD_NODE_TYPE_INDEX = 1095;
    ...
    public const int AMBIENT_AND_DIFFUSE_KEYWORD_NODE_TYPE_INDEX = 1096;
    ...
    public const int EMISSION_KEYWORD_NODE_TYPE_INDEX = 1097;
    ...
    //LegacyFogCommands
    public const int MODE_KEYWORD_NODE_TYPE_INDEX = 1098;
    ...
    public const int DENSITY_KEYWORD_NODE_TYPE_INDEX = 1099;
    ...
    //FogModeKeywords
    public const int GLOBAL_KEYWORD_NODE_TYPE_INDEX = 1100;
    ...
    public const int LINEAR_KEYWORD_NODE_TYPE_INDEX = 1101;
    ...
    public const int EXP_KEYWORD_NODE_TYPE_INDEX = 1102;
    ...
    public const int EXP2_KEYWORD_NODE_TYPE_INDEX = 1103;
    ...
    //StencilCommands
    public const int REF_KEYWORD_NODE_TYPE_INDEX = 1104;
    ...
    public const int READ_MASK_KEYWORD_NODE_TYPE_INDEX = 1105;
    ...
    public const int WRITE_MASK_KEYWORD_NODE_TYPE_INDEX = 1106;
    ...
    public const int PASS_FRONT_KEYWORD_NODE_TYPE_INDEX = 1107;
    ...
    public const int PASS_BACK_KEYWORD_NODE_TYPE_INDEX = 1108;
    ...
    public const int COMP_KEYWORD_NODE_TYPE_INDEX = 1109;
    ...
    public const int COMP_FRONT_KEYWORD_NODE_TYPE_INDEX = 1110;
    ...
    public const int COMP_BACK_KEYWORD_NODE_TYPE_INDEX = 1111;
    ...
    public const int FAIL_KEYWORD_NODE_TYPE_INDEX = 1112;
    ...
    public const int FAIL_FRONT_KEYWORD_NODE_TYPE_INDEX = 1113;
    ...
    public const int FAIL_BACK_KEYWORD_NODE_TYPE_INDEX = 1114;
    ...
    public const int ZFAIL_KEYWORD_NODE_TYPE_INDEX = 1115;
    ...
    public const int ZFAIL_FRONT_KEYWORD_NODE_TYPE_INDEX = 1116;
    ...
    public const int ZFAIL_BACK_KEYWORD_NODE_TYPE_INDEX = 1117;
    ...
    public const int GREATER_KEYWORD_NODE_TYPE_INDEX = 1118;
    ...
    public const int GEQUAL_KEYWORD_NODE_TYPE_INDEX = 1119;
    ...
    public const int LESS_KEYWORD_NODE_TYPE_INDEX = 1120;
    ...
    public const int LEQUAL_KEYWORD_NODE_TYPE_INDEX = 1121;
    ...
    public const int EQUAL_KEYWORD_NODE_TYPE_INDEX = 1122;
    ...
    public const int NOT_EQUAL_KEYWORD_NODE_TYPE_INDEX = 1123;
    ...
    public const int ALWAYS_KEYWORD_NODE_TYPE_INDEX = 1124;
    ...
    public const int NEVER_KEYWORD_NODE_TYPE_INDEX = 1125;
    ...
    public const int KEEP_KEYWORD_NODE_TYPE_INDEX = 1126;
    ...
    public const int ZERO_KEYWORD_NODE_TYPE_INDEX = 1127;
    ...
    public const int REPLACE_KEYWORD_NODE_TYPE_INDEX = 1128;
    ...
    public const int INCR_SAT_KEYWORD_NODE_TYPE_INDEX = 1129;
    ...
    public const int DECR_SAT_KEYWORD_NODE_TYPE_INDEX = 1130;
    ...
    public const int INVERT_KEYWORD_NODE_TYPE_INDEX = 1131;
    ...
    public const int INCR_WRAP_KEYWORD_NODE_TYPE_INDEX = 1132;
    ...
    public const int DECR_WRAP_KEYWORD_NODE_TYPE_INDEX = 1133;
    ...
    //BoolKeywords
    public const int TRUE_KEYWORD_NODE_TYPE_INDEX = 1134;
    ...
    public const int FALSE_KEYWORD_NODE_TYPE_INDEX = 1135;
    ...
    public const int ON_KEYWORD_NODE_TYPE_INDEX = 1136;
    ...
    public const int OFF_KEYWORD_NODE_TYPE_INDEX = 1137;
    ...
    private const int LAST_GENERATED_TOKEN_TYPE_INDEX = 1138;  }
}
