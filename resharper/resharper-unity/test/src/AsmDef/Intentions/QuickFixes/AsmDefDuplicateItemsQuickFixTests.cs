...
namespace JetBrains.ReSharper.Plugins.Unity.Tests.AsmDef.Intentions.QuickFixes
{
    ...
    {
        protected override string RelativeTestDataPath => @"AsmDef\Intentions\QuickFixes\DuplicateItems\Availability";
    ...
    {
        protected override string RelativeTestDataPath => @"AsmDef\Intentions\QuickFixes\DuplicateItems";
