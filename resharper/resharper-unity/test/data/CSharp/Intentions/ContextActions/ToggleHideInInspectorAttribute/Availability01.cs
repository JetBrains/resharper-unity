...
public class Foo : MonoBehaviour
{
    ...
    public int my{on:Annotate:'myValue7':with:'HideInInspector':attribute}Value7, my{on:Annotate:'myValue8':with:'HideInInspector':attribute}Value8, my{on:Annotate:'myValue9':with:'HideInInspector':attribute}Value9;
    ...
    [HideInInspector] public string my{on:Remove:'HideInInspector':attribute:from:'myValue12'}Value12;
