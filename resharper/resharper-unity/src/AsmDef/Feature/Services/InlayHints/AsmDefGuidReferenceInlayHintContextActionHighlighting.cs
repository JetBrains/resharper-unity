...
namespace JetBrains.ReSharper.Plugins.Unity.AsmDef.Feature.Services.InlayHints
{
    ...
    public class AsmDefGuidReferenceInlayHintContextActionHighlighting : IAsmDefInlayHintContextActionHighlighting
    {
        private readonly DocumentRange myDocumentRange;

        public AsmDefGuidReferenceInlayHintContextActionHighlighting(DocumentRange documentRange)
        {
