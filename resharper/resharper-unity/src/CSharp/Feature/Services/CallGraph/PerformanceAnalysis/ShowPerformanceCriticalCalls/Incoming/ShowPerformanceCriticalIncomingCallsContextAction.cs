...
namespace JetBrains.ReSharper.Plugins.Unity.CSharp.Feature.Services.CallGraph.PerformanceAnalysis.ShowPerformanceCriticalCalls.Incoming
{
    [ContextAction(
        ...
        Name = ShowPerformanceCriticalCallsUtil.INCOMING_MESSAGE,
        Description = ShowPerformanceCriticalCallsUtil.INCOMING_MESSAGE,
        Disabled = false,
    ...
    public class ShowPerformanceCriticalIncomingCallsContextAction : PerformanceOnlyContextActionBase
    {
        ...
        {
            return new ShowPerformanceCriticalIncomingCallsBulbAction(containingMethod)
