namespace JetBrains.ReSharper.Plugins.Unity.CSharp.Daemon.Stages.PerformanceCriticalCodeAnalysis.Highlightings
{
    ...
    public static class PerformanceHighlightingAttributeIds
    {
        ...
        public const string PERFORMANCE_CRITICAL_CONTEXT_METHOD_HIGHLIGHTER = "ReSharper Unity Performance Critical Context";
        public const string COSTLY_METHOD_CONTEXT_HIGHLIGHTER = "ReSharper Unity Performance Critical Line Marker";
    }
}