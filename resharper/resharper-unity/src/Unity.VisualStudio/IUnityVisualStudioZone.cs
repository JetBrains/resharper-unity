...
namespace JetBrains.ReSharper.Plugins.Unity.VisualStudio
{
    ...
    // It is defined purely so that the VisualStudio/ReSharper tests can have a direct type reference. Without a direct
    // reference, this assembly is not included in container composition and components aren't loaded.
    ...
    [ZoneDefinition]
    public interface IUnityVisualStudioZone : IZone
    {
    }
}