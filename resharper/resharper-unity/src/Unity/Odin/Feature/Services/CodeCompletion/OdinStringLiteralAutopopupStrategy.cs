...
{
    public OdinStringLiteralAutopopupStrategy([NotNull] CSharpCodeCompletionManager codeCompletionManager, [NotNull] ISettingsSchema settingsSchema) : base(codeCompletionManager, settingsSchema)
    {
    }
