...
//     {
//       return new ResourceReferenceSearchSourceFileProcessor<TResult>(element, myReferenceSearcherParameters, consumer, myElements, myWordsInFiles, myNames).Run() == FindExecution.Stop;
//     }
//
//     private class ResourceReferenceSearchSourceFileProcessor<TResult> : ReferenceSearchSourceFileProcessor<TResult>
//     {
//       public ResourceReferenceSearchSourceFileProcessor(ITreeNode treeNode, ReferenceSearcherParameters referenceSearcherParameters, IFindResultConsumer<TResult> resultConsumer, IDeclaredElementsSet elements, ICollection<string> wordsInText, ICollection<string> referenceNames) 
