...
//         {
//             Assertion.Assert(token is IXmlValueToken, "token is IXmlValueToken");
//             return new UxmlNamespaceReference((IUxmlTreeNode) owner, qualifier, (IXmlValueToken) token, rangeWithin);
//         }
//
