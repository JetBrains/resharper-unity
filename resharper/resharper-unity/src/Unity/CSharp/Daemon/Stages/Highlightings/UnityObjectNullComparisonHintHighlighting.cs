...
public class UnityObjectNullComparisonHintHighlighting(
    IEqualityExpression expression,
    PushToHintMode mode = PushToHintMode.Always)
    : IUnityHighlighting, IInlayHintWithDescriptionHighlighting, IHighlightingWithTestOutput
{
    public const double DefaultOrder = 2;
    public PushToHintMode Mode { get; } = mode;
