...
namespace JetBrains.ReSharper.Plugins.Unity.CSharp.Psi.CodeStyle.Formatting
{
    ...
    {
        [SettingsEntry(true, DescriptionResourceType: typeof(Strings), DescriptionResourceName: nameof(Strings.UnityCSharpFormattingSettingsKey_s_Force_a_line_break_after_any__Header__annotations))]
        public bool ENFORCE_CUSTOM_HEADER_FORMATTING;
        
        [SettingsEntry(true, DescriptionResourceType: typeof(Strings), DescriptionResourceName: nameof(Strings.UnityCSharpFormattingSettingsKey_s_Blank_lines_after_the__Header__annotations))]
