...
{
    [GeneratorBuilder(GeneratorUnityKinds.UnityEventFunctions, typeof(CSharpLanguage), Instantiation.DemandAnyThreadUnsafe /* TODO check possibility to mark this class and dependencies as DemandAnyThreadSafe */)]
