...
{
    [GeneratorBuilder(GeneratorUnityKinds.UnityEventFunctions, typeof(CSharpLanguage) /* TODO check possibility to mark this class and dependencies as DemandAnyThreadSafe */)]
