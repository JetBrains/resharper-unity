...
LPAREN="("
RPAREN=")"
UNQUOTED_STRING_LITERAL_START_CHAR=("#"|"_"|{LETTER_CHAR}|{LPAREN})
...
UNQUOTED_STRING_LITERAL_REST=({UNQUOTED_STRING_LITERAL_PART_CHAR}*{UNQUOTED_STRING_LITERAL_END_CHAR})
UNQUOTED_STRING_LITERAL=({UNQUOTED_STRING_LITERAL_START_CHAR}{UNQUOTED_STRING_LITERAL_REST}*)|({DECIMAL_DIGIT}{UNQUOTED_STRING_LITERAL_REST}+)
...
<PARENS>        {INTEGER_LITERAL}               { return ShaderLabTokenType.NUMERIC_LITERAL; }
<PARENS>        {FLOAT_LITERAL}                 { return ShaderLabTokenType.NUMERIC_LITERAL; }
...
<YYINITIAL,BRACKETS>        {INTEGER_LITERAL}   { return ShaderLabTokenType.NUMERIC_LITERAL; }
<YYINITIAL,BRACKETS>        {FLOAT_LITERAL}     { return ShaderLabTokenType.NUMERIC_LITERAL; }
