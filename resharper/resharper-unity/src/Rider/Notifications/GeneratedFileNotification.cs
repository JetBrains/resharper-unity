            ...
            solutionLifecycleHost.FullStartupFinished.Advise(fullStartupFinishedLifetimeDefinition.Lifetime, _ =>
            {
                textControlHost.ViewHostTextControls(lifetime, (lt, id, host) =>
                {
                    ...
                    unityEditorStateHost.State.View(lt, (unityStateLifetime, state) =>
                    {
                        ...
                        if (path != null && state != EditorState.Disconnected)
                        {
                            var strPath = path.Components.Join("/").RemoveStart("../");
                            elements.Add(new NotificationPanelCallbackHyperlink(unityStateLifetime,
                        ...
                        notificationPanelHost.AddNotificationPanel(unityStateLifetime, host,
