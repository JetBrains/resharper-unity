...
[assembly: RegisterHighlighter(HighlightingGroupIds.CodeInsightsGroup + "x", 
...
namespace JetBrains.ReSharper.Plugins.Unity.Rider.Lenses
{
    [StaticSeverityHighlighting(Severity.INFO, HighlightingGroupIds.CodeInsightsGroup, 
        AttributeId = HighlightingGroupIds.CodeInsightsGroup + "x", OverlapResolve = OverlapResolveKind.NONE 
    )]
