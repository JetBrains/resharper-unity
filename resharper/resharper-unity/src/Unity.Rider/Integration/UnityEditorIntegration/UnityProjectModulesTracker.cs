...
public interface IUnityProjectModulesTracker
{
    IViewableProperty<UnityPlatformInfo?> UnityPlatformInfo { get; }
}

[SolutionComponent(Instantiation.DemandAnyThreadSafe)]
public class UnityProjectModulesTracker : IUnityProjectLazyComponent, IUnityProjectModulesTracker
{
