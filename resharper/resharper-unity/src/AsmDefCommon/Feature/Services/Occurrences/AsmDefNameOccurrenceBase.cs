...
{
    public abstract class AsmDefNameOccurrenceBase<TLanguage> : IAsmDefNameOccurence where TLanguage : PsiLanguageType
    {
        ...
        public AsmDefNameOccurrenceBase(string name, IPsiSourceFile sourceFile,
            ...
            TabOptions tabOptions = TabOptions.Default)
        {
            ...
            if (psiFile == null || !psiFile.Language.Is<TLanguage>())
                return false;
