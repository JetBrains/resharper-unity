...
//    }
    ...
    [TestUnity]
    public class TypeInsteadOfStringQuickFixTest : QuickFixTestBase<TypeInsteadOfStringQuickFix>
    {
        protected override string RelativeTestDataPath => @"CSharp\Intentions\QuickFixes\TypeInsteadString";
