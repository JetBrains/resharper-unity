...
{
    public abstract class UnityMonoStartInfoHandlerBase<T> : UnityStartInfoHandlerBase<T>
        where T : UnityMonoStartInfoBase
    {
        protected UnityMonoStartInfoHandlerBase() : base(SoftDebuggerType.Instance)
        {
        }
        ...
        protected static SoftDebuggerStartArgs CreateSoftDebuggerStartInfo(UnityMonoStartInfoBase startInfo)
        {
