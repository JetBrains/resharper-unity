...
class UnityExeConfigurationType : ConfigurationTypeBase(id, UnityBundle.message("configuration.type.name.standalone.player"), // "RunUnityExe" preserved for compatibility
