...
class ShaderLabSyntaxHighlighter : RiderTableBasedSyntaxHighlighter(table) {
    companion object {
        ...
        val directives = listOf("#include", "#pragma", "#define", "#elif", "#else", "#elseif", "#endif", "#if", "#ifdef")
        ...
        private val ourKeys: Map<IElementType, TextAttributesKey> = mapOf(
    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<TextAttributesKey> {
        if (ourKeys.containsKey(tokenType))
