...
class UnityExeConfiguration(name:String, project: Project, factory: ConfigurationFactory, val params: DotNetExeConfigurationParameters)
    ...
    override fun getState(executor: Executor, environment: ExecutionEnvironment): RunProfileState{
        ...
        if (executorId == DefaultDebugExecutor.EXECUTOR_ID)
        {
            ...
            return UnityExeAttachProfileState(this, DotNetRemoteConfiguration(project, ConfigurationTypeUtil.findConfigurationType(MonoRemoteConfigType::class.java).factory, name), environment)
        }
