...
import com.jetbrains.rider.projectView.nodes.findProjects
...
class AutoSaveNotification(private val propertiesComponent: PropertiesComponent, project: Project, private val unityHost: UnityHost,
    ...
    private fun showNotificationIfNeeded(tabName : String){
        ...
        // avoid showing, when non of the projects is loaded
        if (!ProjectModelViewHost.getInstance(project).findProjects().any()) return
