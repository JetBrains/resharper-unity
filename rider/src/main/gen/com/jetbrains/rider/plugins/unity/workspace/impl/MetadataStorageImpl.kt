...
internal object MetadataStorageImpl : MetadataStorageBase() {
  override fun initializeMetadata() {
    ...
    typeMetadata = EntityMetadata(fqName = "com.jetbrains.rider.plugins.unity.workspace.UnityPackageEntity",
                                                      ...
                                                      OwnPropertyMetadata(isComputable = false,
                                                                          ...
                                                                          valueType = ValueTypeMetadata.SimpleType.CustomType(isNullable = false,
                                                                                                                              typeMetadata = FinalClassMetadata.ClassMetadata(
                                                                                                                                fqName = "com.jetbrains.rider.plugins.unity.model.frontendBackend.UnityPackage",
                                                                                                                                properties = listOf(
                                                                                                                                  OwnPropertyMetadata(
                                                                                                                                    isComputable = false,
                                                                                                                                    isKey = false,
                                                                                                                                          ...
                                                                                                                                          typeMetadata = FinalClassMetadata.ClassMetadata(
                                                                                                                                            ...
                                                                                                                                            properties = listOf(
                                                                                                                                              ...
                                                                                                                                              OwnPropertyMetadata(
                                                                                                                                                ...
                                                                                                                                                withDefault = false)),
                                                                                                                                            supertypes = listOf(
                                                                                                                                              "com.jetbrains.rd.util.string.IPrintable")))),
  ...
  override fun initializeMetadataHash() {
    addMetadataHash(typeFqn = "com.jetbrains.rider.plugins.unity.workspace.UnityPackageEntity", metadataHash = 975239526)
    addMetadataHash(typeFqn = "com.jetbrains.rider.plugins.unity.model.frontendBackend.UnityPackage", metadataHash = -1727222796)
    addMetadataHash(typeFqn = "com.jetbrains.rider.plugins.unity.model.frontendBackend.UnityPackageDependency", metadataHash = 664033308)
