...
@Feature("Unit Testing in Unity solution with started Unity2023")
@Severity(SeverityLevel.CRITICAL)
@TestEnvironment(platform = [PlatformType.WINDOWS_ALL, PlatformType.MAC_OS_ALL])
class UnitTestingTest2023 : IntegrationTestWithUnityProjectBase() {
    override fun getSolutionDirectoryName() = "UnityDebugAndUnitTesting/Project"
    override val unityMajorVersion = UnityVersion.V2023
    @Test
    @Description("Check run all tests from project with Unity2023")
