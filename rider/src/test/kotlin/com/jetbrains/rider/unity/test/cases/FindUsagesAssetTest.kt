...
open class FindUsagesAssetTest : FindUsagesAssetTestBase() {
    @ParameterizedTest(name = "{0}") // Find script usages with Unity2017 scene model
    ...
    @ParameterizedTest(name = "{0}") // Find EventHandler usages with Unity2017 scene model
    @MethodSource("findUsagesGrouping")
    ...
    @ParameterizedTest(name = "{0}") // Find script usages with Unity2018 scene model
    @MethodSource("findUsagesGrouping")
    ...
    @ParameterizedTest(name = "{0}") // Find EventHandler usages with Unity2018 scene model
    @MethodSource("findUsagesGrouping")
    ...
    @ParameterizedTest(name = "{0}") // Find EventHandlerPrefabs usages with Unity2018 scene model
    @MethodSource("findUsagesGrouping")
    ...
    @ParameterizedTest(name = "{0}") // Find VoidHandler usages
    @MethodSource("findUsagesGrouping")
    ...
    @ParameterizedTest(name = "{0}") // Find IntHandler usages
    @MethodSource("findUsagesGrouping")
    @Solution("FindUsages_event_handlers_2018")
    ...
    @ParameterizedTest(name = "{0}") // Find FloatHandler usages
    @MethodSource("findUsagesGrouping")
    @Solution("FindUsages_event_handlers_2018")
    ...
    @ParameterizedTest(name = "{0}") // Find BoolHandler usages
    @MethodSource("findUsagesGrouping")
    @Solution("FindUsages_event_handlers_2018")
    ...
    @ParameterizedTest(name = "{0}") // Find ObjectHandler usages
    @MethodSource("findUsagesGrouping")
    @Solution("FindUsages_event_handlers_2018")
    ...
    @ParameterizedTest(name = "{0}") // Find UnityEventHandler usages
    @MethodSource("findUsagesGrouping")
    @Solution("FindUsages_event_handlers_2018")
    ...
    @ParameterizedTest(name = "{0}") // Find PropertyHandler usages
    @MethodSource("findUsagesGrouping")
    @Solution("FindUsages_event_handlers_2018")
