...
- Add file to correct project when moving with drag and drop in Unity Explorer ([#1501](https://github.com/JetBrains/resharper-unity/pull/1501))
- Add context menu to create Unity Assets menu item for a `ScriptableObject` ([#1567](https://github.com/JetBrains/resharper-unity/pull/1567))
- Show serialised field values for scriptable objects ([#1567](https://github.com/JetBrains/resharper-unity/pull/1567))
- Show usage count, and support find usages of scriptable objects ([#1567](https://github.com/JetBrains/resharper-unity/pull/1567))
