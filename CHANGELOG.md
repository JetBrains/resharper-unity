...
- Rider: Add option to disable debugger extensions ([#1741](https://github.com/JetBrains/resharper-unity/pull/1741))
...
- Rider: Show various Unity types such as `Vector3` with full float precision ([#1741](https://github.com/JetBrains/resharper-unity/pull/1741))
